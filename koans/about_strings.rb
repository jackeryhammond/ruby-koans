...
EOS
  ...
  def test_plus_concatenation_will_leave_the_original_strings_unmodified
    hello = "Hello "
    there = "There "
    general = ", General " # Had to be done
    kenobi = "Kenobi"
  ...
  def test_plus_equals_also_will_leave_the_original_string_unmodified # this is worded weirdly
  ...
  def test_strings_can_be_split
    ...
    words = string.split # so default is ' '?
